    ...
    def decide(self):
        ...
        if self.stage == 0:
            ...
            if base.c_area[wagent.position] == ECell.Material:
                material_type = base.warehouse.ammo_materials[wagent.position].type
                if wagent.materials_bag[material_type] < 2 and \
                        base.warehouse.ammo_materials[wagent.position].count > 0:
