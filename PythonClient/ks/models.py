...
class Agent(object):
    ...
    def __init__(self, type=None, position=None, materials_bag=None, c_materials_bag_capacity=None, ammos_bag=None,
                 c_ammos_bag_capacity=None):
        self.initialize(type, position, materials_bag, c_materials_bag_capacity, ammos_bag, c_ammos_bag_capacity)

    def initialize(self, type=None, position=None, materials_bag=None, c_materials_bag_capacity=None, ammos_bag=None,
                   c_ammos_bag_capacity=None):
        self.type = type
        self.position = position
...
class Unit(object):
    ...
    def __init__(self, type=None, health=None, c_individual_health=None, c_individual_damage=None,
                 c_damage_distribution=None, ammo_count=None, reload_rem_time=None, c_reload_duration=None):
        self.initialize(type, health, c_individual_health, c_individual_damage, c_damage_distribution, ammo_count,
                        reload_rem_time, c_reload_duration)

    def initialize(self, type=None, health=None, c_individual_health=None, c_individual_damage=None,
                   c_damage_distribution=None, ammo_count=None, reload_rem_time=None, c_reload_duration=None):
        self.type = type
        self.health = health
...
class Base(object):
    ...
    def __init__(self, c_area=None, agents=None, frontline_deliveries=None, warehouse=None, backline_delivery=None,
                 factory=None, units=None):
        self.initialize(c_area, agents, frontline_deliveries, warehouse, backline_delivery, factory, units)

    def initialize(self, c_area=None, agents=None, frontline_deliveries=None, warehouse=None, backline_delivery=None,
                   factory=None, units=None):
        self.c_area = c_area
        self.agents = agents
